...
namespace AIronMan.DataSource.Postgres.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<AIronMan.DataSource.Postgres.DB>
    {
        ...
        protected override void Seed(AIronMan.DataSource.Postgres.DB context)
        {
            new List<User> {
                        new User{
